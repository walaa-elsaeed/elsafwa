...
<p class="info" style="color: #777777;font-size: 18px;line-height: 1.6">
    ...
    Please click on the link to reset your old password
</p>

<a href="{{route('reset',$email_token)}}" style="color: white;text-decoration: none;background: #2679a4;padding: 10px 60px">
