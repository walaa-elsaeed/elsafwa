                ...
                <div class="col-md-offset-1 col-md-10 col-xs-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <p>
                                <a class="btn btn-success" href="{{url('join_cyber')}}">Add</a>
                            </p>

                            <div class="tabbable">
                                <ul class="nav nav-tabs">
                                    <li><a href="{{url('joined-list')}}">Active</a></li>
                                    <li class="active"><a href="{{url('blocked-list')}}">Blocked</a></li>
                                </ul>
...
<script>
    $('#users-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{url('getblockedcybers')}}',
        columns: [
            { data: 'DT_Row_Index', name: 'DT_Row_Index' },
            { data: 'name', name: 'name' },
            { data: 'email', name: 'email' },
            { data: 'phone', name: 'phone' },
            { data: 'tournamentUsername', name: 'tournamentUsername' },
            { data: '# Of Matches', name: '# Of Matches' },
            { data: 'paied matches', name: 'paied matches' },
