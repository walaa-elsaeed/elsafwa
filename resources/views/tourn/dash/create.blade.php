    ...
    <div class="row" style="padding-top: 6%">
        <div class="col-md-offset-1 col-md-10 col-xs-12">
            <div class="box box-primary">
                ...
                <form method="post" action="{{'storetourn'}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="box-body">
                            ...
                            <div class="tab-pane active" id="tab_1">
                                <div class="col-xs-12 cus-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" placeholder="Name" name="name"  style="width: 100%">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab_2">
                                <div class="col-xs-12 cus-12">
                                    <div class="form-group form-ar">
                                        ...
                                        <input type="text" class="form-control" id="name" placeholder="الاسم" name="name_ar" style="width: 100%">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane active" id="tab_3">
                                <div class="col-xs-12 cus-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="name" placeholder="Description" name="description"  rows="5" style="width: 100%"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab_4">
                                <div class="col-xs-12 cus-12">
                                    <div class="form-group form-ar">
                                        ...
                                        <textarea class="form-control" id="name" placeholder="الموضوع" name="description_ar" rows="5" style="width: 100%"></textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-xs-12 cus-12">
                            <div class="form-group reli">
                                ...
                                <div class="form-group">
                                    <img id="profile-img" src="{{url('img/tourn.jpg')}}"  alt="" style="width:500px;height: 500px;border: 1px dashed #0080c4"/>
