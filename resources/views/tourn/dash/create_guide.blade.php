    ...
    <div class="row" style="padding-top: 6%">
        <div class="col-md-offset-1 col-md-10 col-xs-12">
            <div class="box box-primary">
                ...
                <form method="post" action="{{url('save_guide')}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="box-body">
                            ...
                            <div class="tab-pane active" id="tab_3">
                                <div class="col-xs-12 cus-12">
                                    <div class="form-group reli">
                                        <input type="text" name="guide_en" placeholder="type rule here" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab_4">
                                <div class="col-xs-12 cus-12">
                                    <div class="form-group reli form-ar">
                                        <input type="text" name="guide_ar" placeholder="type rule here" class="form-control">
