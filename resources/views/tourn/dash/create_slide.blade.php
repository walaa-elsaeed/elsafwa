    ...
    <div class="row" style="padding-top: 6%">
        <div class="col-md-offset-1 col-md-10 col-xs-12">
            <div class="box box-primary">
                ...
                <form method="post" action="{{'storeheaderslide'}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="box-body">
                            ...
                            <div class="tab-pane active" id="tab_3">
                                <div class="col-xs-12 cus-12">
                                    <div class="form-group reli">
                                        ...
                                        <div class="form-group">
                                            <img id="profile-img" src="{{url('img/slider.png')}}" alt=""
                            ...
                            <div class="tab-pane" id="tab_4">
                                <div class="col-xs-12 cus-12">
                                    <div class="form-group reli form-ar">
                                        ...
                                        <input type="file"  class="upload-hidden" name="file_ar" style="width: 100%!important;height: 100%!important;"  onchange="readURL2(this);">
                                        <button class="btn btn-default upload">
                                            ارفع
                                        </button>
                                        <div class="form-group form-ar">
                                            <img id="profile-img-ar" src="{{url('img/slider.png')}}" alt=""
                                                 style="width:100%;height: 500px;border: 1px dashed #0080c4"/>
