        ...
        <div class="col-md-offset-1 col-md-10 col-xs-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <p>
                        <a class="btn btn-success" href="{{url('admin/books/create')}}">اضافه كتاب</a>
                    </p>

                    <div class="tabbable">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="{{url('admin/books')}}">كل الكتب</a></li>
                        </ul>
