<script>
    var dataTable;
    function updateTable($blog){
        var filter = $blog;
        if(filter == undefined){
            filter = 0;
        }
        var url = '{{url("admin/all_blog_articles")}}';
        url +='/'+filter;
        ...
        <div class="col-md-offset-1 col-md-10 col-xs-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <p>
                        <a class="btn btn-success" href="{{url('admin/blog_articles/create')}}">اضافه مقال</a>
                    </p>

                    <div class="tabbable">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="{{url('admin/blog_articles')}}">كل المقالات</a></li>
                        </ul>
    ...
    <script>
        $(function() {
            dataTable = $('#users-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{url('admin/all_blog_articles')}}'+'/0',
                columns: [
