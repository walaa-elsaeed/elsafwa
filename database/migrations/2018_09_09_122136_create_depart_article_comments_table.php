...
class CreateDepartArticleCommentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('depart_articel_comments', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('depart_articel_comments');
    }
}
